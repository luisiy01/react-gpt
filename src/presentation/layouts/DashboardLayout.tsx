                ...
                {/* Opciones del menú */}
                {
                    menuRoutes.map(option => (
                        <NavLink
                            key={option.to}
                            to={option.to}
                            className={({ isActive }) => isActive ? "flex justify-center items-center bg-gray-800 p-2 trnsition-colors" : "flex justify-center items-center hover:bg-gray-800 rounded-md p-2 trnsition-colors"}
                        >
